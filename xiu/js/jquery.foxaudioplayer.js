...
(function ($) {
    ...
    $.fn.foxaudioplayer = function(options) {
        ...
        return this.each(function(index) {
            ...
            $(this).find('.mdtc-clnplra-main-player').addClass('mdtc-clnplra-foxaudioplayer-id-' + currentId);
            ...
            if (settings.playlist.length > 1) {
                ...
                var playerSelectors = {
                    jPlayerAudio: '.mdtc-clnplra-foxaudioplayer-id-' + currentId + ' .mdtc-clnplra-jplayer',
                    cssSelectorAncestor: '.mdtc-clnplra-foxaudioplayer-id-' + currentId
                };

                var initPlayerAudio = new jPlayerAudioPlaylist(playerSelectors, playerListFiles, playerOptions);

            } else {
                $('.mdtc-clnplra-foxaudioplayer-id-' + currentId + ' .mdtc-clnplra-jplayer').jPlayerAudio({
                    ready: function (event) {
...
$(function(){
	$('.mediatec-foxaudioplayer').foxaudioplayer();
});